...
Done
El único cambio clave es la primera línea:

❌ export default async function handler
✅ module.exports = async function handler
Pasos en GitHub:

Ve a api/analizar-arte.js
Pulsa el lápiz ✏️ (Edit)
Selecciona todo el texto → bórralo
Pega el código de arriba
Commit
Cuando Vercel redesplegue (~1 min), prueba de nuevo. 🎯
